...
describe "the recipe form", :type => :feature do
  ...
  #   visit '/recipes/new'
  #   fill_in :recipe_ingredients_attributes_quantity, with: '1 cup'
  #   fill_in :recipe_ingredients_attributes_name, with: 'sugar'
  #   fill_in :recipe_ingredients_attributes_quantity, with: '1 tablespoon'
  #   fill_in :recipe_ingredients_attributes_name, with: 'vanilla'
  #   find('input[name="commit"]').click
